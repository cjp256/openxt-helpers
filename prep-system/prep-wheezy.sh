...
sudo apt-get -y install guilt iasl quilt bin86 bcc libncurses5-dev libsdl1.2-dev liburi-perl genisoimage policycoreutils binutils gcc make
sudo apt-get -y install g++ texi2html makeinfo svn gawk chrpath 
